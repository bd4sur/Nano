...
class TrainGPT():
    ...
    def __init__(self, config) -> None:
        ...
        self.dtype = config["dtype"]            # DDP and AMP
        self.is_compile = config["is_compile"]  # DDP
        self.grad_clip = config["grad_clip"]    # DDP
        self.gradient_accumulation_steps = config["gradient_accumulation_steps"] # DDP
        ...
        self.val_data = None
        self.scaler = None       # DDP and AMP
        self.ctx = None          # DDP
        self.is_ddp = False      # DDP
        self.ddp_local_rank = 0  # DDP
    ...
    def init_model(self):
        ...
        # compile the model
        if self.is_compile:
            self.log("Compiling the model... (takes a ~minute)")
