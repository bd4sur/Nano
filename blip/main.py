...
with torch.no_grad():
    # beam search
    caption = model.generate(image, sample=False, num_beams=1, max_length=512, min_length=50)
    # nucleus sampling
    # caption = model.generate(image, sample=True, top_p=0.9, max_length=512, min_length=50)
