...
def generate_sft_dataset():
    ...
    tokenizer = Tokenizer()
    tokenizer.build_from_text(fulltext, os.path.join(os.path.dirname(__file__), "checkpoint/problem_sort_tokenizer.json"))

    train_path = os.path.join(os.path.dirname(__file__), "dataset/problem_sort_train.base64")
    val_path   = os.path.join(os.path.dirname(__file__), "dataset/problem_sort_val.base64")
