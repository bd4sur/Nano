...
def create_recognizer():
    encoder = "/home/bd4sur/ai/_model/sherpa-onnx-streaming-paraformer-bilingual-zh-en/encoder.int8.onnx"
    decoder = "/home/bd4sur/ai/_model/sherpa-onnx-streaming-paraformer-bilingual-zh-en/decoder.int8.onnx"
    tokens = "/home/bd4sur/ai/_model/sherpa-onnx-streaming-paraformer-bilingual-zh-en/tokens.txt"
...
def init_punct_model():
    model = "/home/bd4sur/ai/_model/sherpa-onnx-punct-ct-transformer-zh-en-vocab272727-2024-04-12/model.onnx"
...
def main():
    ...
    with sd.InputStream(channels=1, dtype="float32", samplerate=sample_rate) as s:
        while True:
            ...
            if result:
                print(punct.add_punctuation(result))
                # if is_endpoint:
                #     if result:
                #         result = punct.add_punctuation(result)
                #         print(result)
