...
$(BIN_DIR)/nano_pod: main.c ups_coremp135.c platform_linux.c display_linux_framebuffer.c keyboard_mp135.c vsop87c_milli.c celestial.c ephemeris.c nongli.c flip.c graphics.c ui.c ui_app.c utils.c tokenizer.c tensor.c infer.c | $(BIN_DIR)
